...
\begin{center}
    ...
    \vspace{0.2cm}
    {\Large \textbf{FACULTY OF ELECTRICAL AND ELECTRONICS ENGINEERING}} \\
    \vspace{2.5cm}
    
    \includegraphics[width=6cm]{01_logobachkhoasang.png} \\
    \vspace{3cm}
    
    {\Huge \textbf{EXERCISE REPORT}} \\
    \vspace{0.8cm}
    {\Large \textbf{Course: ASIC Verification (EE5213)}} \\
    
    \vspace{3.5cm}
    
    \begin{flushright}
    \begin{tabular}{rl}
        \textbf{Instructor:} & \textbf{TRAN HOANG LINH} \\
        \textbf{Student:} & \textbf{Vu Tien Giang - 2570188} \\
    \end{tabular}
    \end{flushright}
