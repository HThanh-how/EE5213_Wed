...
\begin{center}
    ...
    \vspace{0.8cm}
    {\Large \textbf{Môn học: ASIC Verification (EE5213)}} \\
    
    \vspace{3.5cm}
    
    \begin{flushright}
    \begin{tabular}{rl}
        \textbf{Giảng viên hướng dẫn:} & \textbf{...........................} \\
        \textbf{Sinh viên:} & \textbf{Vũ Tiến Giang - 2570188} \\
    \end{tabular}
    \end{flushright}
    
    \vfill
    
    {\large Thành phố Hồ Chí Minh, Năm \the\year}
